...
/*
g++ exercise_14.cpp lib_files/Graph.cpp lib_files/Window.cpp lib_files/GUI.cpp lib_files/Simple_window.cpp -o main `fltk-config --ldflags --use-images`
...
int main()
{
	...
	Binary_tree tr (Point(400,50),3,"v");
